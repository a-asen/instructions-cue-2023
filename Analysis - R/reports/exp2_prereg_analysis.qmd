...
```{r table - linear mixed-effect model , echo=FALSE}
par_test("rt") |>
...
test_one_less |> 
  ...
  mutate(
    Variable = case_when(Variable=="post_cue"~"Cue", 
                         ...
                         Variable=="post_cue:congruent"~"Cue_X_Congruency"),
...
```{r table - remove outliers and test, echo=FALSE}
trns_mod(o_rt_aov) |> 
...
```{r table of bayesian coefs, echo=FALSE, warning=FALSE, message=FALSE} 
coefs |> 
  list_rbind() |>
