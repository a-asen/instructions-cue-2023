...
load("../data/sim/exp2_estimate_effect_500.rdata")
load("../data/sim/exp2_gpower_effect_500.rdata")
...
# stop cluster
stopCluster(cl)
#save(est.eff_sim500, file="../data/sim/exp2_estimate_effect_500.rdata")
```
...
# stop cluster
stopCluster(cl)
#save(gpow.eff_sim500, file="../data/sim/exp2_gpower_effect_500.rdata")
```
...
# stop cluster
stopCluster(cl)
#save(g.eff_2x2x2_sim500, file="../data/sim/design_2x2x2_gpower_eff.rdata") # not correct fix
```
