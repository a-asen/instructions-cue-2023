...
We have to solution to this problem: Increase the sample size or increase the number of diagnostic trials. 

Regarding the diagnostic trials, we are weary of adding too many diagnostic trials given that the cue is supposed to signal "sooner-rather-than-later" switching. Increasing the number of diagnostic trials might influence the utility of the cue. 


The plot below visualize the effect size across diagnostic length for a sample size of 30.  
...
With 34 participants and 70 trials of the post-cue diagnostic runs, we should have 90 % power even to a small effect of .15.
