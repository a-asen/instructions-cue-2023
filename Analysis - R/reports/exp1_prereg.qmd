...
A total of
`r loss$inducer_practice_trials + loss$rt_sd_trials + loss$inducer_fail_trials + loss$inducer_practice_trials` trials were lost. Representing a loss of
`r round(loss$inducer_practice_pct + loss$rt_sd_prop + loss$inducer_fail_prop + loss$inducer_practice_prop, 2)` percent of the data.
...
rt_test      <- t.test(  d3$rt_FALSE, d3$rt_TRUE, paired = TRUE, alternative = "greater" )
